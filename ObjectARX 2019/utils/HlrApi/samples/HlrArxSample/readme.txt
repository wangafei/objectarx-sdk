...
This sample demonstrates the use of AsdkHlrApi23.

The AsdkHlrApi23 module is there to help to calculate hidden lines 
...
To use these applications, AsdkHlrApi23.dbx should be copied into the 
AutoCAD folder. First the OS must find it and second AutoCAD must find 
it for the acrxLoadModule("AsdkHlrApi23.dbx",0) call to succeed.
