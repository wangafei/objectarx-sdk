...
VAR_DEF(OdInt16,          TXTHATCH, (1), (1), (), ValidateRange(0, 1))
DICR21VAR(OdInt16,          DIMTOFFSET, (1), (1), (), ValidateRange(0, 1))//add by ZhaoXuan for #72286
DICR27VAR(OdString,         DIMLAYER, (OdString(OD_T("."))), (OdString(OD_T("."))), (), ValidateDimLayer())
//新增变量}}
// New in Red Deer
...
DICR21VAR( OdInt16,                LIGHTINGUNITS,        (2),                     (2),                           (),                             ValidateRange(1,2))
...
DICR27VAR(OdInt16,               POINTCLOUDLIGHTING,    (2),                  (2),                          (),                         ValidateRange(0,2))
DICR27VAR(OdInt16,               POINTCLOUDLIGHTSOURCE, (0),                  (0),                          (),                         ValidateRange(0,1))
DICR27VAR(OdInt16,               POINTCLOUDSHADING,     (0),                  (0),                          (),                         ValidateRange(0,1))
DICR27VAR(OdInt16,               POINTCLOUDVISRETAIN,   (1),                  (1),                          (),                         ValidateRange(0,1))

DICR27VAR(double,                SECTIONOFFSETINC,      (6.0),                (6.0),                        (),                         ValidateNone())
...
REGVAR_DEF(OdInt16,             THUMBSAVE,  (1),					(),       ValidateRange(0,1))
...
REGVAR_DEF(OdInt32        ,HPMAXLINES     ,(100000)    ,()    ,ValidateRange(100,1000000))
...
REGVAR_DEF(OdInt16        ,SMOOTHMESHCONVERT     ,(3)    ,()    ,ValidateRange(3,3))//原范围为(0,3),网格转换曲面/三维实体bool参数无效，所以暂时只使用数值3
...
REGVAR_DEF(OdInt16        ,BLKOPT,				(1),			     (),ValidateRange(0,3))
...
REGVAR_DEF(OdInt16        ,POINTCLOUD2DVSDISPLAY, (0), (), ValidateRange(0, 1))
REGVAR_DEF(OdInt16        ,POINTCLOUDCACHESIZE, (512), (), ValidateRange(0, 32000))
...
REGVAR_DEF(OdInt32, HPSEGLIMIT, (3000), (0), ValidateRange(1, 99999))
...
SEGVAR_DEF(OdInt16        ,NOTESHOWMODE, (1), (), ValidateRange(0, 1))
