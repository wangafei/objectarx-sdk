...
Execute these tasks in order first:
  ...
  1. Using a text editor, update polysamp.reg.
     ...
     Install ID now uses the country code. Change "ACAD-0001:409" in the registry
     ...
     [HKEY_LOCAL_MACHINE\SOFTWARE\Autodesk\AutoCAD\R21.0\ACAD-0001:409\Applications\AsdkPolyCAD]
