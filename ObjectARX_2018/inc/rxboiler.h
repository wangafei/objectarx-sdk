...
#define ACRX_DEFINE_GPDESC(CLASS_NAME) \
    AcRxClass* CLASS_NAME::gpDesc = acrxQueueClassForInitialization(&CLASS_NAME::gpDesc, &CLASS_NAME::rxInit);
