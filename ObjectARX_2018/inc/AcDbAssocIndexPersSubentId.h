...
public:
    ...
    virtual AcDb::SubentType subentType(const AcDbEntity*, AcDbDatabase*) const { return mSubentType; }

    virtual bool isNull() const { return mSubentType == AcDb::kNullSubentType; }
