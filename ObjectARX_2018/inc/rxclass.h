...
ACBASE_PORT void acrxInitTypeSystem();          // for internal use only
ACBASE_PORT void acrxTerminateTypeSystem();     // for internal use only
...
void acrxInitializeClassObjects();      // for internal use only
