...
#ifdef _AFXEXT
	#pragma comment (lib ,"acui22.lib")
	#pragma comment (lib ,"adui22.lib")
...
#pragma comment (lib ,"AcFdEval.lib")
	...
	#pragma comment (lib ,"aseapi22.lib")
	#pragma comment (lib ,"asiapi22.lib")
#else
	#pragma comment (lib ,"aseapi22d.lib")
	#pragma comment (lib ,"asiapi22d.lib")
#endif
