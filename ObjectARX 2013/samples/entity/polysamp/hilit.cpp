...
createInsert()
{
    ...
    //      rotation angle
    //
    acedCommand(RTSTR, _T("_globcheck"), RTSHORT, 0, RTNONE);

	acedCommand(RTSTR, _T("zoom"), RTSTR, _T("e"), RTNONE);

    acedCommand(RTSTR, _T("_BLOCK"), RTSTR, _T("blk3"), RTSTR, _T("0,0"),
                RTSTR, _T("14,8"), RTSTR, _T("11,1"), RTSTR, _T(""),
                RTNONE);

    acedCommand(RTSTR, _T("_INSERT"), RTSTR, _T("blk3"), RTSTR,
                _T("0,0"), RTSHORT, 1, RTSHORT, 1, RTSHORT,
                0, RTNONE);

    acedCommand(RTSTR, _T("_BLOCK"), RTSTR, _T("blk2"), RTSTR, _T("0,0"),
                RTSTR, _T("9,8"), RTSTR, _T("6,1"), RTSTR, _T("11,1"),
                RTSTR, _T(""), RTNONE);

    acedCommand(RTSTR, _T("_INSERT"), RTSTR, _T("blk2"), RTSTR,
                _T("0,0"), RTSHORT, 1, RTSHORT, 1, RTSHORT,
                0, RTNONE);

    acedCommand(RTSTR, _T("_BLOCK"), RTSTR, _T("blk1"), RTSTR, _T("0,0"),
                RTSTR, _T("4,8"), RTSTR, _T("1,1"), RTSTR, _T("6,1"),
                RTSTR, _T(""), RTNONE);

    acedCommand(RTSTR, _T("_INSERT"), RTSTR, _T("blk1"), RTSTR,
                _T("0,0"), RTSHORT, 1, RTSHORT, 1, RTSHORT,
                0, RTNONE);
