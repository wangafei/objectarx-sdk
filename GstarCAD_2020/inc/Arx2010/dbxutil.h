...
#define acdbGetDimTextDirection                            gcdbGetDimTextDirection
#define acdbSetDimTextDirection                            gcdbSetDimTextDirection
...
#define acdbSwapBlockEntities                              gcdbSwapBlockEntities
