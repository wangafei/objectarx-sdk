...
OD_ERROR_DEF( eEmbeddedIntersections                   , OD_T("Embedded Intersections"))
...
OD_ERROR_DEF(eFileLockedByACAD, OD_T("File Locked By ACAD"))
OD_ERROR_DEF(eUserUnloaded, OD_T("User Un loaded"))
OD_ERROR_DEF(eFSMError, OD_T("FSM Error"))
OD_ERROR_DEF(eBadMaterialName, OD_T("Bad Material Name"))
OD_ERROR_DEF(eAlreadyInferred, OD_T("Already Inferred"))
OD_ERROR_DEF(eNotClonedPrimaryProxy, OD_T("Not Cloned PrimaryProxy"))
OD_ERROR_DEF(eNullNodeId, OD_T("Null Node Id"))
OD_ERROR_DEF(eNoNodeActive, OD_T("No Node Active"))
OD_ERROR_DEF(eGraphContainsProxies, OD_T("Graph Contains Proxies"))
OD_ERROR_DEF(eCannotPlotToFile, OD_T("Cannot Plot To File"))
OD_ERROR_DEF(eBackgroundPlotInProgress , OD_T("Background Plot In Progress"))
OD_ERROR_DEF(eNotShownInPropertyPalette, OD_T("Not Shown In Property Palette"))
OD_ERROR_DEF(eNoOverride, OD_T("No Override"))
OD_ERROR_DEF(eNoStoredOverrides, OD_T("No Stored Overrides"))
OD_ERROR_DEF(eUnableToRetrieveOverrides, OD_T("Unable To Retrieve Overrides"))
OD_ERROR_DEF(eUnableToStoreOverrides, OD_T("Unable To StoreOverrides"))
OD_ERROR_DEF(eUnableToRemoveOverrides, OD_T("Unable To Remove Overrides"))
...
OD_ERROR_DEF(eDataLinkSourceUpdateNotAllowed, OD_T("Data Link Source Update Not Allowed"))
OD_ERROR_DEF(eDataLinkExcelNotFound, OD_T("Data Link Excel Not Found"))
OD_ERROR_DEF(eXrefReloaded, OD_T("Xref Reloaded"))
OD_ERROR_DEF(eNoAcDbHostApplication, OD_T("No AcDbHost Application"))
OD_ERROR_DEF(eNoUnderlayHost, OD_T("No Underlay Host"))
OD_ERROR_DEF(eInetBase, OD_T("InetBase"))
...
OD_ERROR_DEF(eInetNoAcadInet, OD_T("Inet No Acad Inet"))
