...
public:
   ...
   ZCMPOLYGON_PORT virtual Zcad::ErrorStatus subGetClassID( CLSID* pClsid) const; 

    ZCMPOLYGON_PORT virtual ZSoft::Boolean    subWorldDraw(ZcGiWorldDraw*  mode);
    ZCMPOLYGON_PORT virtual void              saveAs(ZcGiWorldDraw* mode, ZcDb::SaveType st);
    ...
    ZCMPOLYGON_PORT virtual ZcDbEntity*       subSubentPtr(const ZcDbFullSubentPath& id) const;	
    ...
    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus subGetStretchPoints(ZcGePoint3dArray& stretchPoints) const;   

    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus subMoveStretchPointsAt( const ZcDbIntArray& indices,		
        const ZcGeVector3d& offset);

    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus   subTransformBy(const ZcGeMatrix3d& xform);	

    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus	subGetGeomExtents(ZcDbExtents& extents) const; 		

    ZCMPOLYGON_PORT virtual void              subList() const;	
    
    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus   subExplode( ZcDbVoidPtrArray& entitySet) const;	

    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus dwgInFields(ZcDbDwgFiler* filer);
    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus dwgOutFields(ZcDbDwgFiler* filer) const;
    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus dxfInFields(ZcDbDxfFiler* filer);
    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus dxfOutFields(ZcDbDxfFiler* filer) const;
    ZCMPOLYGON_PORT virtual Zcad::ErrorStatus audit(ZcDbAuditInfo* );
...
class ZCMPOLYGON_PORT ZcDbMpolygonLoops {
public:
...
class ZCMPOLYGON_PORT ZcDbMPolygonCrossingArray {
public:
