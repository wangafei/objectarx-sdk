...
class ZCDB_PORT ZcDbAssoc2dConstraintGroup : public ZcDbAssocAction
{
public:
...
class ZCDB_PORT ZcDbAssoc2dConstraintCallback
{
public:
...
class ZCDB_PORT ZcAutoConstrainEvaluationCallback
{
