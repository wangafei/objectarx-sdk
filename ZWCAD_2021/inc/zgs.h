...
public:
	...
	virtual bool                onAdded                 (ZcGsModel* , ZcGiDrawable * , LONG_PTR       ) { return true; }
	virtual bool                onErased                (ZcGsModel* ,	ZcGiDrawable * , ZcGiDrawable * )  { return true; }
	virtual bool                onErased                (ZcGsModel* ,	ZcGiDrawable * ,	LONG_PTR       ) { return true; }
	virtual bool                onModified              (ZcGsModel* , ZcGiDrawable * , ZcGiDrawable * )  { return true; }
	virtual bool                onModified              (ZcGsModel* , ZcGiDrawable * , LONG_PTR       ) { return true; }
};
...
public:
	...
	bool requires(const ZcUniqueString *capability) const
    { 
        return capability ? contains(capability) : false; 
    }

    static DRAWBRIDGE_API const ZcUniqueString *k2DDrawing;    
    static DRAWBRIDGE_API const ZcUniqueString *k3DDrawing;    
    static DRAWBRIDGE_API const ZcUniqueString *k3DSelection;  
    static DRAWBRIDGE_API const ZcUniqueString *k3DRapidRTRendering;  
};
