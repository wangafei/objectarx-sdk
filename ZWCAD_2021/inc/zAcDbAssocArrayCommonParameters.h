...
class ZCDB_PORT ZcDbAssocArrayCommonParameters : public ZcDbAssocArrayParameters
{
public:
    ZCRX_DECLARE_MEMBERS(ZcDbAssocArrayCommonParameters);

    virtual ~ZcDbAssocArrayCommonParameters(void);
    ...
    virtual ZcDbItemLocator getCanonicalForm(const ZcDbItemLocator& locator) const;
