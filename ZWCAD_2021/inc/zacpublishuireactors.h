...
class ZcPublishUIReactor2 : public ZcPublishUIReactor
{
public:

    virtual void PersistenceRegistryForPubishOptionsDialog(const ZTCHAR* lpszRegRoot,
        bool bIsReadRegistry = true) {}

    virtual ~ZcPublishUIReactor2() {}
