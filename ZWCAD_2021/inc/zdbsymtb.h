...
public:
    ...
    Zcad::ErrorStatus setTransparency(const ZcCmTransparency& trans, const ZcDbObjectId& viewportId);
...
public:
	...
	Zcad::ErrorStatus font(ZcString& pTypeface, ZSoft::Boolean& bold, ZSoft::Boolean& italic, Charset& charset, 
		ZwSoft::ZwCAD::PAL::FontUtils::FontPitch& pitch, 
		ZwSoft::ZwCAD::PAL::FontUtils::FontFamily& family) const;
    Zcad::ErrorStatus font(ZTCHAR*& pTypeface, ZSoft::Boolean& bold, ZSoft::Boolean& italic, Charset& charset, 
		ZwSoft::ZwCAD::PAL::FontUtils::FontPitch& pitch, 
		ZwSoft::ZwCAD::PAL::FontUtils::FontFamily& family) const;
protected:
    virtual Zcad::ErrorStatus subGetClassID(CLSID* pClsid) const override;
