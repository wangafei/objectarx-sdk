...
class ZCDB_PORT ZcDbAssocDimDependencyBodyBase : public ZcDbAssocDependencyBody
{
public:
    ...
    virtual ~ZcDbAssocDimDependencyBodyBase();
    ...
    virtual Zcad::ErrorStatus updateDependentOnObjectOverride() override;
    ...
    virtual Zcad::ErrorStatus isRelevantChangeOverride(bool& isRelevChange) const override;

    virtual void evaluateOverride() override;

    virtual void modifiedOverride(const ZcDbObject* pDbObj) override;

    virtual void erasedOverride(const ZcDbObject* pDbObj, ZSoft::Boolean isErasing) override;
    ...
    class ZCDB_PORT NotificationIgnorer
    {
    public:
