...
class ZCDB_PORT ZcEdSSGetFilter: public ZcEdInputContextReactor
{
public:
...
Zcad::ErrorStatus setAllowDuplicateSelection(
                        ZcApDocument *pDoc, unsigned char flag);
...
class ZCDB_PORT ZcEdSSGetFilter2 : public ZcEdSSGetFilter
{
public:
...
class ZcEdSSGetFilter4 : public ZcEdSSGetFilter
{
public:
   virtual void
    endNEntsel(
...
Zcad::ErrorStatus addSSgetFilterInputContextReactor(
    ZcApDocument *pDoc, ZcEdSSGetFilter4 *pFilter);
Zcad::ErrorStatus removeSSgetFilterInputContextReactor(
    ZcApDocument *pDoc, ZcEdSSGetFilter4 *pFilter);
