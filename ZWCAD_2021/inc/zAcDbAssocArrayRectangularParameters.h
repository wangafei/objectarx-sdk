...
class ZCDB_PORT ZcDbAssocArrayRectangularParameters : public ZcDbAssocArrayCommonParameters
{
public:
    ...
    virtual ~ZcDbAssocArrayRectangularParameters(void);
    ...
    virtual Zcad::ErrorStatus getItems(ZcArray<ZcDbAssocArrayItem*>& items) const;

    virtual Zcad::ErrorStatus getItemPosition(const ZcDbItemLocator& locator,
        ZcGePoint3d& position, ZcGeMatrix3d& xform) const;
