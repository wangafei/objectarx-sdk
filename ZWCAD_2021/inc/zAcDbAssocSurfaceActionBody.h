...
public:
    ...
    virtual Zcad::ErrorStatus getDependentActionsToEvaluateOverride(ZcDbActionsToEvaluateCallback*) const override;

    virtual Zcad::ErrorStatus addMoreObjectsToDeepCloneOverride(
        ZcDbIdMapping&, ZcDbObjectIdArray& additionalObjectsToClone) const override;

    virtual Zcad::ErrorStatus dragStatusOverride(const ZcDb::DragStat) override;
