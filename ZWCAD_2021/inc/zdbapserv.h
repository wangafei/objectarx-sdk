...
public:
	...
	template<size_t nDevNameLen, size_t nStyleNameLen>bool getDefaultPlotCfgInfo(
		ZTCHAR (&plotDeviceName)[nDevNameLen], ZTCHAR (&plotStyleName)[nStyleNameLen])
	{
	...
	virtual ZcadInternalServices2* zcadInternalServices2();	
