...
class ZCDB_PORT ZcDb2dPolyline: public ZcDbCurve
{
public:
    ZcDb2dPolyline();
    ~ZcDb2dPolyline();
...
class ZCDB_PORT ZcDb3dPolyline: public ZcDbCurve
{
public:
    ZcDb3dPolyline();
    ~ZcDb3dPolyline();
...
class ZCDB_PORT ZcDbArc: public ZcDbCurve
{
public:
    ZcDbArc();
...
class ZCDB_PORT ZcDbCircle: public ZcDbCurve
{
public:
    ZcDbCircle();
...
class ZCDB_PORT ZcDbLine: public ZcDbCurve
{
public:
    ZcDbLine();
...
class ZCDB_PORT ZcDbPoint: public ZcDbEntity
{
public:
    ZcDbPoint();
...
class ZCDB_PORT ZcDbFace: public ZcDbEntity
{
public:
    ZcDbFace();
...
class ZCDB_PORT ZcDbPolyFaceMesh: public ZcDbEntity
{
public:
    ZcDbPolyFaceMesh();
    ~ZcDbPolyFaceMesh();
...
class ZCDB_PORT ZcDbPolygonMesh: public ZcDbEntity
{
public:
    ZcDbPolygonMesh();
...
class ZCDB_PORT ZcDbSolid: public ZcDbEntity
{
public:
    ZcDbSolid();
...
class ZCDB_PORT ZcDbTrace: public ZcDbEntity
{
public:
    ZcDbTrace();
...
class ZCDB_PORT ZcDbShape: public ZcDbEntity
{
public:
    ZcDbShape();
...
class ZCDB_PORT ZcDbViewport: public ZcDbEntity
{
public:
                      ZcDbViewport();
                      ~ZcDbViewport();
