...
protected:
    ...
    ZCBASE_PORT virtual Zcad::ErrorStatus subInvoke(ZcRxObject* pO, ZcRxValue& param) const;

    ZCBASE_PORT virtual Zcad::ErrorStatus subIsExecutable(const ZcRxObject* pO, const ZcRxValue& param) const;
