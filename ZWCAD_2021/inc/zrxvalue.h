...
#undef new
            ::new ((Storage*)this) ZcRxValue(rhs, !isInlined() && !rhs.isInlined()); 
...
public:
    ...
    ZCBASE_PORT virtual ZcRxObject*       clone() const ZSOFT_OVERRIDE;

    ZCBASE_PORT virtual Zcad::ErrorStatus copyFrom(const ZcRxObject* other) ZSOFT_OVERRIDE;

    ZCBASE_PORT virtual ZSoft::Boolean    isEqualTo(const ZcRxObject * other) const ZSOFT_OVERRIDE;

    ZCBASE_PORT virtual ZcRx::Ordering    comparedTo(const ZcRxObject * other) const ZSOFT_OVERRIDE;
...
public:
    ...
    ZCBASE_PORT virtual const ZcRxValue* value() const ZSOFT_OVERRIDE;

    ZCBASE_PORT virtual ZcRxValue* value() ZSOFT_OVERRIDE;
};
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGeMatrix3d& m) throw();

template<>
ZCBASE_PORT ZcGeMatrix3d* rxvalue_cast<ZcGeMatrix3d>(ZcRxValue* value) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcCmColor& clr) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcDbDate& str) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcUnderlayLayer& str) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGiMaterialColor& clr) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGiMaterialMap& clr) throw();
#pragma endregion
...
{
    ZCDB_PORT static const ZcRxValueType& value() throw();
    static void del();
};

template<>
ZCDB_PORT ZcRxValue::ZcRxValue(const ZcDbSweepOptions& sweepOptions) throw();
#pragma endregion
...
template<>
ZCDB_PORT ZcRxValue::ZcRxValue(const ZcDbLoftOptions& loftOptions) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGiShadowParameters& v) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGiSkyParameters& v) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGiToneOperatorParameters& v) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGiPhotographicExposureParameters& v) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcGiLightAttenuation& v) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(ZcDbMText* const& pMText) throw();

template<>
ZCBASE_PORT ZcDbMText* const* rxvalue_cast<ZcDbMText*>(const ZcRxValue * value) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcDbTableCellBlockReference& tableCellBlkRef) throw();
#pragma endregion
...
template<>
ZCDB_PORT ZcRxValue::ZcRxValue(const ZcDbBlockParamValueSet& blcParamValueSet) throw();
#pragma endregion
...
template<>
ZCDB_PORT ZcRxValue::ZcRxValue(const ZcDbBlkParamValueSetValuesArray& blockParamValueSetArr) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcDbIntArray& intArr) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const DimFillColor& dimFillColor) throw();
#pragma endregion
...
template<>
ZCBASE_PORT ZcRxValue::ZcRxValue(const ZcStringArray& stringArray) throw();
#pragma endregion