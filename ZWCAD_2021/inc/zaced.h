...
ZCAD_PORT bool zcedCmdLookup(const ZTCHAR* cmdStr, bool globalLookup,
...
public:
    ...
    ZSOFT_DEPRECATED virtual void beginDwgOpen(ZTCHAR*) final {};
...
ZCAD_PORT const ZcString* zcedGetUnitsValueString(ZcDb::UnitsValue units);
