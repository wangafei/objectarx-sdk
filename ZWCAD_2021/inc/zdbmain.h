...
ZCDBCORE2D_PORT Zcad::ErrorStatus zcdbOpenObject(ZcDbObject *& pObj, ZcDbObjectId id, ZcDb::OpenMode mode = ZcDb::kForRead, bool openErased = false);
...
ZCDBCORE2D_PORT Zcad::ErrorStatus zcdbSaveAs2004(ZcDbDatabase* pDb,
	const ZTCHAR* fileName);

ZCDBCORE2D_PORT Zcad::ErrorStatus zcdbSaveAs2000(ZcDbDatabase* pDb,
	const ZTCHAR* fileName);

ZCDBCORE2D_PORT Zcad::ErrorStatus zcdbSaveAsR14(ZcDbDatabase* pDb,
	const ZTCHAR* fileName);

ZCDBCORE2D_PORT Zcad::ErrorStatus zcdbDxfOutAs2004(ZcDbDatabase* pDb,
	const ZTCHAR* fileName,
	const int precision = 16);

ZCDBCORE2D_PORT Zcad::ErrorStatus zcdbDxfOutAs2000(ZcDbDatabase* pDb,
	const ZTCHAR* fileName,
	const int precision = 16);

ZCDBCORE2D_PORT Zcad::ErrorStatus zcdbDxfOutAsR12(ZcDbDatabase* pDb,
	const ZTCHAR* fileName,
	const int precision = 16);
...
public:
    ...
    ZSOFT_SEALED_VIRTUAL Zcad::ErrorStatus deepClone(ZcDbObject* pOwnerObject,
                                        ZcDbObject*& pClonedObject,
                                        ZcDbIdMapping& idMap,
                                        ZSoft::Boolean isPrimary = true) const ZSOFT_SEALED;	
 
	ZSOFT_SEALED_VIRTUAL  Zcad::ErrorStatus wblockClone(ZcRxObject* pOwnerObject,
                                          ZcDbObject*& pClonedObject,
                                          ZcDbIdMapping& idMap,
                                          ZSoft::Boolean isPrimary = true) const ZSOFT_SEALED;	
   ...
   virtual ZcGsNode*           gsNode() const;
    ...
    ZSOFT_SEALED_VIRTUAL Zcad::ErrorStatus   getClassID(CLSID* pClsid) const ZSOFT_SEALED;
...
public:
    ...
    virtual ZcCmEntityColor::ColorMethod  colorMethod() const override;
    virtual Zcad::ErrorStatus setColorMethod(ZcCmEntityColor::ColorMethod eColorMethod) override;
    ...
    virtual ZSoft::UInt32     color() const override;
    virtual Zcad::ErrorStatus setColor(ZSoft::UInt32 color) override;

    virtual Zcad::ErrorStatus setRGB  (ZSoft::UInt8 red, 
                               ZSoft::UInt8 green, 
                               ZSoft::UInt8 blue) override;
    virtual Zcad::ErrorStatus setRed  (ZSoft::UInt8 red) override;
    virtual Zcad::ErrorStatus setGreen(ZSoft::UInt8 green) override;
    virtual Zcad::ErrorStatus setBlue (ZSoft::UInt8 blue) override;
    virtual ZSoft::UInt8      red  () const override;
    virtual ZSoft::UInt8      green() const override;
    virtual ZSoft::UInt8      blue () const override;

    virtual ZSoft::UInt16     colorIndex() const override;
    virtual Zcad::ErrorStatus setColorIndex(ZSoft::UInt16 colorIndex) override;
    virtual ZSoft::UInt16     penIndex() const override;   
    virtual Zcad::ErrorStatus setPenIndex (ZSoft::UInt16 penIndex) override;

    virtual Zcad::ErrorStatus setNames(const ZTCHAR *colorName,
                                       const ZTCHAR *bookName = NULL) override;
    virtual const ZTCHAR *      colorName(void) const override;
    virtual const ZTCHAR *      bookName(void) const override;
    virtual const ZTCHAR *      colorNameForDisplay(void) override;
...
public:
	...
	virtual bool                bounds(ZcDbExtents& bounds) const override;
      ...
      ZSOFT_SEALED_VIRTUAL ZSoft::Boolean      cloneMeForDragging() ZSOFT_SEALED;
      ZSOFT_SEALED_VIRTUAL bool                hideMeForDragging() const ZSOFT_SEALED;

    virtual void                dragStatus(const ZcDb::DragStat status);
      ZSOFT_SEALED_VIRTUAL void                gripStatus(const ZcDb::GripStat status) ZSOFT_SEALED;
      ZSOFT_SEALED_VIRTUAL void                subentGripStatus(
                                    const ZcDb::GripStat      status,
                                    const ZcDbFullSubentPath& subentity) ZSOFT_SEALED;

      ZSOFT_SEALED_VIRTUAL Zcad::ErrorStatus getGripEntityUCS(const void* pGripAppData,
        ZcGeVector3d& normalVec, ZcGePoint3d& origin, ZcGeVector3d& xAxis) const ZSOFT_SEALED;
protected:
