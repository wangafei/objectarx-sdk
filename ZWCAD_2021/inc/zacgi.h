...
public:
    ...
    virtual void setMappingCoords (MapChael mapChael, const ZcGePoint3d* pCoords);  
    virtual ZcGePoint3d* mappingCoords (MapChael mapChael) const; 
private: 
...
public:
    ...
    virtual Zcad::ErrorStatus font(ZTCHAR *& pTypeface, bool& bold,
