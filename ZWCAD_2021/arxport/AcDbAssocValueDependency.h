#ifndef __ACDBASSOCVALUEDEPENDENCY_H__
#define __ACDBASSOCVALUEDEPENDENCY_H__

#include "AcDbAssocDependency.h"

#include "../inc/zAcDbAssocValueDependency.h"
...
#endif //#ifndef __ACDBASSOCVALUEDEPENDENCY_H__
