#ifndef __ACDBASSOCDEPENDENCYBODY_H__
#define __ACDBASSOCDEPENDENCYBODY_H__

#include "AcDbAssocDependency.h"

#include "../inc/zAcDbAssocDependencyBody.h"
...
#endif //#ifndef __ACDBASSOCDEPENDENCYBODY_H__