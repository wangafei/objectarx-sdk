...
with the behaviour of various functions within acbr22.dll, and
to exemplify proper usage of the functions in an integrated
environment.  Please note that if you wish to use acbr22.dll in
your own application you must load it by using acrxDynamicLinker
as in the sample app because acbr22.dll is an ARX application
