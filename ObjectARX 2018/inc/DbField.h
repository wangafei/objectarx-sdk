...
public:
    ...
    ACDBCORE2D_PORT AcDbField::EvalStatus evaluationStatus(int* pnErrCode = NULL, 
    ...
    ACDBCORE2D_PORT Acad::ErrorStatus getFieldCode(ACHAR*& pszFieldCode, 
    ...
    ACDBCORE2D_PORT Acad::ErrorStatus getFormat   (ACHAR*& pszFormat) const;
    ...
    ACDBCORE2D_PORT Acad::ErrorStatus getValue    (ACHAR*& pszValue) const;
    ...
    ACDBCORE2D_PORT Acad::ErrorStatus getHyperlink(ACHAR** pszName,
