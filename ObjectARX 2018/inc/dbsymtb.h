...
public:
    ...
    /// <summary>
    /// This function will set font
    /// </summary>
    /// <param name="pTypeface">Input font name </param>
    /// <param name="bold">Input Boolean indicating bold text  </param>
    /// <param name="italic">Input Boolean indicating italic text </param>
    /// <param name="charset">Input indicating the character set being used</param>
    ...
    /// <summary>
    /// This function will get font information
    /// <summary>
    /// <param name="pTypeface">Returns font name  </param>
    /// <param name="bold">Returns Boolean indicating bold text  </param>
    /// <param name="italic">Returns Boolean indicating italic text </param>
    /// <param name="charset">Returns indicating the character set being used </param>
    /// <param name="pitch">Returns indicating the pitch being used </param>
    /// <param name="family">Returns indicating the family being used </param>
    /// <returns>Returns Acad::eOk if successful.</returns>
