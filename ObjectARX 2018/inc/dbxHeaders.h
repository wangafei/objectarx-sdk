...
#pragma comment (lib ,"acdb22.lib")
#pragma comment (lib ,"acge22.lib")
#pragma comment (lib ,"acISMobj22.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st22.lib") 
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl22.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex22.lib")
	#pragma comment (lib ,"acbr22.lib")
#endif // _BREP_SUPPORT_
#else // AC_FULL_DEBUG
#pragma comment (lib ,"rxapi.lib")
#pragma comment (lib ,"acdb22d.lib")
#pragma comment (lib ,"acge22d.lib")
#pragma comment (lib ,"acISMobj22d.lib")
#pragma comment (lib ,"acgiapi.lib")
#pragma comment (lib ,"axdb.lib")
#pragma comment (lib ,"ac1st22d.lib") 
#ifdef _DBX_HOST_APPLICATION_
	#pragma comment (lib ,"acurlutl22d.lib")
#endif // _DBX_HOST_APPLICATION_
#ifdef _BREP_SUPPORT_
	#pragma comment (lib ,"acgex22d.lib")
	#pragma comment (lib ,"acbr22d.lib")
#endif // _BREP_SUPPORT_
#endif // AC_FULL_DEBUG

#ifdef _HLR_SUPPORT_
	#pragma comment (lib ,"AsdkHlrApi22.lib")
#endif
