...
#endif
#else
#define GCDB_REGISTER_OBJECT_ENTRY_PRAGMA(classname)
#endif
...
public:
  GcRxDbxApp() : m_hdllInstance(NULL), m_bUnlocked(true), m_bMDIAware(true) {}
  ...
  virtual GcRx::AppRetCode On_kLoadDwgMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kUnloadDwgMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kInvkSubrMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kCfgMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kEndMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kQuitMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kSaveMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kDependencyMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kNoDependencyMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kOleUnloadAppMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kPreQuitMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kInitDialogMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kEndDialogMsg(void *pkt) { return (GcRx::kRetOK); }
  virtual GcRx::AppRetCode On_kNullMsg(void *pkt) { return (GcRx::kRetOK); }
...
#if !defined(_WIN64) && !defined (_GC64)
#pragma comment(linker, "/export:_gcrxGetApiVersion,PRIVATE")
#else
#pragma comment(linker, "/export:gcrxGetApiVersion,PRIVATE")
#endif