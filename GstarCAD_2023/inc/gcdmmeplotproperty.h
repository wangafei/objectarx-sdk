...
/////////////////////////////////////////////////////////////////////////////////////////
//
#ifndef GcDMMEPlotProperty_h
#define GcDMMEPlotProperty_h

#include "gcarray.h"

class GcDMMXMLAttribute
{
public:
  GcDMMXMLAttribute()
  {
  ...
  GcDMMXMLAttribute(const wchar_t *ns, const wchar_t *nsUrl,
  ...
  const GcDMMXMLAttribute& operator= (const GcDMMXMLAttribute& src)
  {
    if (this != &src)
    {
      setNull();
  ...
  GcDMMXMLAttribute(const GcDMMXMLAttribute& src)
  {
    *this = src;
  }
...
typedef GcArray<GcDMMXMLAttribute> GcDMMXMLAttributeVec;

class GcDMMEPlotProperty
{
public:
  ...
  GcDMMEPlotProperty(const wchar_t *name, const wchar_t * value)
  {
    if (NULL != name) {
  ...
  GcDMMEPlotProperty(const GcDMMEPlotProperty &src)
  {
    m_name = NULL;
    m_value = NULL;
    m_type = NULL;
  ...
  GcDMMEPlotProperty& operator= (const GcDMMEPlotProperty& src)
  {
    if (this == &src)
      return *this;
  ...
  void AddXMLAttribute(const GcDMMXMLAttribute * attrib)
  {
    if (attrib)
  ...
  void AddXMLAttribute(const wchar_t *ns, const wchar_t *nsUrl, const wchar_t *attName, const wchar_t *attValue)
  {
    if (NULL != ns && NULL != nsUrl && NULL != attName && NULL != attValue)
      m_XMLAttributes.append(GcDMMXMLAttribute(ns, nsUrl, attName, attValue));
  }

  const GcDMMXMLAttributeVec& GetXMLAttributes() const
  {
...
private:
  ...
  GcDMMXMLAttributeVec    m_XMLAttributes;
};

typedef GcArray<GcDMMEPlotProperty> GcDMMEPlotPropertyVec;
