...
#define GCDB_MODEL_SPACE               GCRX_T("*Model_Space")
#define GCDB_PAPER_SPACE               GCRX_T("*Paper_Space")
#define GCDB_NULL_HANDLE GCRX_T("\0\0\0\0\0\0\0")  
#define GCDB_OPEN_BRACE_STR            GCRX_T("{")
#define GCDB_OPEN_BRACE_CHAR           GCRX_T('{')
#define GCDB_CLOSE_BRACE_STR           GCRX_T("}")
#define GCDB_CLOSE_BRACE_CHAR          GCRX_T('}')
#define GCDB_GROUP_DICTIONARY          GCRX_T("ACAD_GROUP")
#define GCDB_MLINESTYLE_DICTIONARY     GCRX_T("ACAD_MLINESTYLE")
#define GCDB_LAYOUT_DICTIONARY         GCRX_T("ACAD_LAYOUT")
#define GCDB_PLOTSETTINGS_DICTIONARY   GCRX_T("ACAD_PLOTSETTINGS")
#define GCDB_PLOTSTYLENAME_DICTIONARY  GCRX_T("ACAD_PLOTSTYLENAME")
#define GCDB_MATERIAL_DICTIONARY       GCRX_T("ACAD_MATERIAL")
#define GCDB_VISUALSTYLE_DICTIONARY    GCRX_T("ACAD_VISUALSTYLE")
#define GCDB_COLOR_DICTIONARY          GCRX_T("ACAD_COLOR")
#define GCDB_TABLESTYLE_DICTIONARY     GCRX_T("ACAD_TABLESTYLE")
#define GCDB_EMBEDDED_OBJECT_STR       GCRX_T("Embedded Object")
#define GCDB_LAYERSTATES_DICTIONARY    GCRX_T("ACAD_LAYERSTATES")
#define GCDB_FIELD_DICTIONARY          GCRX_T("ACAD_FIELD")
#define GCDB_FIELDLIST                 GCRX_T("ACAD_FIELDLIST")
#define GCDB_ENHANCED_BLOCK            GCRX_T("ACAD_ENHANCEDBLOCK")
#define GCDB_ENHANCED_BLOCK_EVALKEY    GCRX_T("ACAD_ENHANCEDBLOCKEVALKEY")
#define GCDB_ENHANCED_BLOCK_REF        GCRX_T("ACAD_ENHANCEDBLOCK_REFERENCE")
#define GCDB_SECTION_MANAGER           GCRX_T("ACAD_SECTION_MANAGER")
#define GCDB_DATALINK                  GCRX_T("ACAD_DATALINK")
#define GCDB_MLEADERSTYLE_DICTIONARY   GCRX_T("ACAD_MLEADERSTYLE")
#define GCDB_ASSOCNETWORK_DICTIONARY   GCRX_T("ACAD_ASSOCNETWORK")
#define GCDB_SECTIONSTYLE_DICTIONARY   GCRX_T("ACAD_SECTIONVIEWSTYLE")
#define GCDB_DETAILSTYLE_DICTIONARY    GCRX_T("ACAD_DETAILVIEWSTYLE")

#define GCDB_ANNOTATIONSCALES_COLLECTION gcdbAnnotationScaleCollectionName()
...
struct GcDb
{
  ...
  typedef Gsoft::UInt32    SubentType;
  enum {
    kNullSubentType = 0,
    kFaceSubentType = 1,
    kEdgeSubentType = 2,
  ...
  enum MaintenanceReleaseVersion
  {
    ...
    kMReleaseExtendedNewest = kMRelease205,
