...
class GCAD_PORT CNavDialog : public CGdUiDialog
{
...
protected:
  ...
  GDUI_REPLY OnNotifyControlChange(UINT controlId, LPARAM lParam) override;
  GDUI_REPLY OnNotifyGeneric(UINT controlId, LPARAM lParam) override;
