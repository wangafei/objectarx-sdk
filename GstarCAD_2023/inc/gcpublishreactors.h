...
/////////////////////////////////////////////////////////////////////////////////////////
//
#ifndef _GCPUBLISHREACTORS_H
#define _GCPUBLISHREACTORS_H
...
class GcPublishReactorManager;
class GcPublishReactor;
...
class GcPublishReactor : public GcRxObject
{
public:
  virtual void OnAboutToBeginBackgroundPublishing(GcPublishBeforeJobInfo
    *pInfo);
...
inline void
GcPublishReactor::OnAboutToBeginBackgroundPublishing(GcPublishBeforeJobInfo
  *pInfo) {};
...
inline void
GcPublishReactor::OnCancelledOrFailedPublishing(GcPublishReactorInfo
  *pInfo) {};
