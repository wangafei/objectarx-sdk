...
#define	gds_command	MustSwitchTo_gcedCommandC_or_gcedCommandS - - !
#define	gds_cmd	MustSwitchTo_gcedCmdC_or_gcedCmdS
...
#define	gds_grxloaded	gcedGrxLoaded
#define	gds_grxload	gcedGrxLoad
#define	gds_grxunload	gcedGrxUnload
#define	gds_invoke	gcedInvoke
#define	gds_getvar	gcedGetVar
#define	gds_findfile	gcedFindFile
#define	gds_findtrustedfile	gcedFindTrustedFile
...
#ifdef __STDC__
#define gds_name_set(from, to)  (memcpy(to, from, sizeof(gds_name)))
#define gds_point_set(from,to)  (memcpy(to, from, sizeof(gds_point)))
#else
...
#define	gds_rangtos	gcdbRawAngToS
#define	gds_rtos	gcdbRToS
#define	gds_angtof	gcdbAngToF
#define	gds_rangtof	gcdbRawAngToF
