...
/////////////////////////////////////////////////////////////////////////////////////////
//
#ifndef GCPLDSDDATA_H
#define GCPLDSDDATA_H
...
public:
  ...
  GCPL_PORT void              setMajorVersion(unsigned int majorVersion);

  GCPL_PORT unsigned int      minorVersion() const;
  GCPL_PORT void              setMinorVersion(unsigned int minorVersion);
