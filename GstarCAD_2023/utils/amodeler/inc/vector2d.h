...
public:
  ...
  operator GcGeVector2d& () { return *((GcGeVector2d*)this); }
  operator const GcGeVector2d& () const { return *((const GcGeVector2d*)this); }

  static Vector2d& cast(GcGeVector2d& v) { return *(Vector2d*)&v; }

  Vector2d(const GcGeVector2d& v) { *this = *(Vector2d*)&v; }
