...
/////////////////////////////////////////////////////////////////////////////////////////
//
#ifndef GMODELER_INC_INTERVAL_H
#define GMODELER_INC_INTERVAL_H
...
public:
  ...
  Interval1d(double a, double b, int) : lower(a), upper(b) {}
...
public:
  ...
  Interval2d(Point2d a, Point2d b, int) : lower(a), upper(b) {}
...
public:
  ...
  Interval3d(Point3d a, Point3d b, int) : lower(a), upper(b) {}
...
public:
  ...
  IntInterval1d(int a, int b, int) : lower(a), upper(b) {}
...
public:
  ...
  IntInterval2d(IntPoint2d a, IntPoint2d b, int) : lower(a), upper(b) {}
...
public:
  ...
  IntInterval3d(IntPoint3d a, IntPoint3d b, int) : lower(a), upper(b) {}
