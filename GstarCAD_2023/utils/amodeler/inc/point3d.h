...
/////////////////////////////////////////////////////////////////////////////////////////
//
#ifndef GMODELER_INC_POINT3D_H
#define GMODELER_INC_POINT3D_H
...
public:
  ...
  operator GcGePoint3d& () { return *((GcGePoint3d*)this); }
  operator const GcGePoint3d& () const { return *((const GcGePoint3d*)this); }

  static Point3d& cast(GcGePoint3d& p) { return *(Point3d*)&p; }

  Point3d(const GcGePoint3d& p) { *this = *(Point3d*)&p; }
